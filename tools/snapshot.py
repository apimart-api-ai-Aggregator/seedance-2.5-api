#!/usr/bin/env python3
"""Refresh Seedance 2.5 (seedance-2.5) pricing from the public pricing payload.
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Refresh Seedance 2.5 pricing")
